<footer class="bg-ink px-edge-home py-[clamp(40px,5vw,52px)]">
    <div class="max-w-home mx-auto">
        ...
        <div class="flex flex-col flex-wrap items-center justify-between gap-x-10 gap-y-8">
            ...
            <a href="mailto:info@theelectricbuffalo.com"
                class="font-cuerpo text-2xl font-semibold text-amber hover:text-amber/80 transition duration-200">info@theelectricbuffalo.com</a>
        </div>
        ...
        <div
            class="flex flex-col flex-wrap items-center justify-between gap-4 mt-[30px] pt-6 border-t border-rule-dark">
            <p class="text-xs text-rule-light">&copy; {{ date('Y') }} The Electric Buffalo. Todos los derechos
                reservados.</p>
            <div class="flex gap-4">
                <a href="{{ route('politica') }}"
                    class="text-xs text-rule-light hover:text-amber transition duration-200">Política de privacidad</a>
                <a href="{{ route('cookies') }}"
                    class="text-xs text-rule-light hover:text-amber transition duration-200">Política de cookies</a>
            </div>
        </div>
    </div>
</footer>
