...
$classes = ($active ?? false)
            ? 'inline-flex items-center p-4 rounded-lg border border-custom-red text-xl font-medium leading-5 text-custom-white focus:outline-none transition duration-150 ease-in-out'
