<div
    ...
    <img src="{{ asset($disco->imagen ? 'storage/' . $disco->imagen : 'img/no-imagen.jpg') }}" alt="{{ $disco->nombre }}"
    ...
    <div class="datos-producto p-4">
        ...
        <x-button :href="route('discografia.mostrar', $disco)" class="mt-4  w-full font-bold justify-center"
            disabled>{{ $disco->stock > 0 ? 'DISPONIBLE' : 'AGOTADO' }}</x-button>
    </div>
