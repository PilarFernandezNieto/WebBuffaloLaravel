...
<nav x-data="{ open: false }" class="sticky top-0 z-50 bg-ink">
    <div
        class="max-w-home mx-auto flex flex-wrap items-center justify-between gap-y-3 px-[clamp(18px,4vw,40px)] py-[10px]">

        <!-- Logo -->
        <a href="{{ route('welcome') }}" aria-label="The Electric Buffalo — Inicio" class="shrink-0">
            <img src="/img/logo_blanco_transparente.png" alt="The Electric Buffalo"
                class="h-[clamp(44px,7vw,68px)] w-auto object-contain">
        </a>
    ...
    <div :class="{ 'block': open, 'hidden': !open }"
        ...
        <div class="pt-4 space-y-1">
            ...
            <x-responsive-link-nav :href="route('discografia')"
                :active="request()->routeIs('discografia*')">{{ __('Discografía') }}</x-responsive-link-nav>
        ...
        @auth
            <div class="pt-4 pb-1 border-t border-rule-dark mt-4">
                <div class="px-1">
