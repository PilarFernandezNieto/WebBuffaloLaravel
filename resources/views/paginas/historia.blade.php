<x-app-layout pageTitle="Historia">
    <div class=" my-10 w-95p lg:w-4/5 max-w-1300px mx-auto ">
        ...
        <!-- SEGUNDO BLOQUE -->
        <section class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start my-8">

            <!-- Columna izquierda (Imagen vertical) -->
            <div>
                <span class="flex justify-end text-xs text-slate-600">Foto de Manfred</span>
                <img src="/img/TrioJovenVertical.jpg" alt="Foto vertical"
                    class="w-full max-h-[40rem] lg:max-h-[70rem] object-cover object-top">
            </div>
            <!-- Columna derecha -->
            <div class="flex flex-col gap-8 h-full justify-between">
                ...
                <div class="space-y-6">
                    <p class="text-base leading-7">
                        ...
                        mandos al sumo sacerdote de Eclipse Estudios, el gran Dani “Desmond” Sevillano.
                    </p>
                    <p class="text-base leading-7">
                        ...
                        “Keepin’ it
                        warm” (Boomerang Discos), calentito y a punto de salir del horno, cuando ocurrió lo
                        absolutamente
        ...
        <section class="grid lg:grid-cols-2 gap-8 items-start">
            ...
            <div class="flex flex-col justify-between space-y-6 h-full">
                <div class="space-y-3 text-base leading-7 text-gray-800">
                    ...
                    <p>El exilio espiritual tocó a su fin algunas semanas después, con la decisión de seguir adelante y
                        con
                        la llamada a filas de Sergio “Tutu” Rodríguez, bajista de Los Deltonos, fanático de Miles Davis
                        y
                        amo
                        de llaves de “Tutu Estudios” en Corvera, Asturias.</p>
                    <p>Junto con el fabuloso teclista “Stone” Sam Rodríguez, que se une a la banda unos meses después,
                        ...
                        andado
                        sin más pretensión que hacer la música y las canciones que les apetece, sin prisa, exactamente
                        como
                ...
                <div>
                    <span class="block text-right text-xs text-gray-500">Foto de Manfred</span>
                    <img src="/img/wilon_joven.jpg" alt="Wilon joven" class="w-full">
