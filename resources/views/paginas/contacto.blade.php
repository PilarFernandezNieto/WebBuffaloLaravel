<x-app-layout pageTitle="Contacto">
    <div class="max-w-content mx-auto px-edge py-section-lg">
        <p class="font-titulo italic text-oxide text-sm font-semibold uppercase tracking-[1.2px] mb-3">Contacto</p>
        <h1
        ...
        <p class="text-ink-body text-base leading-[1.65] max-w-[56ch] mb-10">Conciertos, prensa o simplemente para
            saludar: te leemos.</p>
