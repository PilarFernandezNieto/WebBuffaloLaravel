...
@if ($noticias->count() > 0)
    <section class="max-w-home mx-auto px-edge-home py-section-lg">
        ...
        <div
            class="grid gap-[clamp(24px,3.5vw,34px)] items-start grid-cols-[repeat(auto-fit,minmax(min(100%,280px),1fr))]">
        ...
        <p class="mt-[clamp(30px,4vw,44px)]">
            <a href="{{ route('noticias') }}"
                class="font-cuerpo text-xs font-bold uppercase tracking-[1px] text-oxide hover:text-oxide-hover transition duration-200">Ver
                todas</a>
        </p>
    </section>
@endif
