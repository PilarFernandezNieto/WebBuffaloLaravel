        ...
        <tbody>
            @forelse ($discos as $disco)
                <tr class="border-b border-rule-light-soft last:border-b-0">
                    <td class="px-4 py-3.5 text-sm font-bold text-ink-muted whitespace-nowrap">{{ $disco->id }}
                    </td>
                    <td class="px-4 py-3.5 min-w-44">
                        <span class="block text-base font-bold text-ink-heading text-pretty">{{ $disco->nombre }}</span>
                    </td>
...
<x-confirm-delete-alert event="eliminarDisco" />
