            ...
            <tbody>
                @foreach ($musicos as $musico)
                    <tr class="hover:bg-slate-50 border-b border-slate-200">
                        <td class="p-4 py-5">
                            <p class="block font-semibold text-sm text-slate-800">{{ $musico->id }}</p>
                        </td>
                        <td class="p-4 py-5">
                            <p class="block text-sm text-slate-800">{{ $musico->nombre }} {{ $musico->apellidos }}</p>
                        </td>
                        <td class="p-4 py-5">
                            <p class="block text-sm text-slate-800">{{ $musico->alias }}</p>
                        </td>
                        <td class="p-4 py-5">
                            <img src="{{ asset('storage/imagenes/' . $musico->imagen) }}" alt="" class="w-32">

                        </td>
                        <td class="p-4 py-5">
                            <p class="block text-sm text-slate-800">{{ $musico->origen }}</p>
                        </td>
                        <td class="p-4 py-5">
                            <div class=" text-center flex">
                                <a href="/" class="text-indigo-600 hover:text-indigo-700 p-2 font-bold">
                                ...
                                <a href="/" class="text-red-600 hover:text-red-800 p-2 font-bold ">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke-width="1.5" stroke="currentColor" class="size-8">
                                        <path stroke-linecap="round" stroke-linejoin="round"
